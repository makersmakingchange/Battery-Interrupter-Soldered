...
This repository contains information on how to build a battery interrupter. A battery interrupter allows users to use an assistive switch with battery-operated devices without modifying the device's internal electronics. This a low cost, soldered version of a battery interrupter. Other versions exist, including the [Flex PCB Battery Interrupter](https://github.com/makersmakingchange/Flex-Battery-Interrupter). This device can be used with AAA, AA, C, or D sized batteries and is inserted between the battery and battery terminal. This device is often used to create switch-adapted toys.
